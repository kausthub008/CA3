...
if(isset($_POST["orderid"]) && !empty($_POST["orderid"])){
  ...
  $ida = $_POST["expid"];
    ...
    $sqla = "DELETE FROM orderexp where orderid = $id";
    $sqlb = "DELETE FROM ordertask where orderid = $id";
  $sqlc = "DELETE FROM orderuser where orderid = $id";
    print "query1 = $sql";
  print "query1 = $sqla";
  print "query1 = $sqlb";
  print "query1 = $sqlc";
          ...
          if($stmta->execute()){
            if($stmtb->execute()){
              ...
              echo "dddd";
               ...
               header("location: orders.php?expid=$ida");
